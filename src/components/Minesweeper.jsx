    ...
    >
      <div className="bg-white p-2 rounded shadow-lg border border-gray-300 w-full h-full">
        <div className="mb-2 flex justify-between items-center">
          ...
          <div>
            <button onClick={resetGame} className="bg-blue-500 text-white px-2 py-1 rounded text-xs mr-1">
              Reset
            </button>
            <button onClick={onClose} className="bg-red-500 text-white px-2 py-1 rounded text-xs">
              Close
            </button>
          </div>
        </div>
        ...
        {gameOver && <div className="mt-2 text-red-500 text-sm">Game Over!</div>}
